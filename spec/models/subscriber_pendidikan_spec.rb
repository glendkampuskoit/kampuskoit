...
describe SubscriberPendidikan do
  before { @subscriberpendidikan = SubscriberPendidikan.new(jenjang: "SMA", institusi:"Departemen Pendidikan Nasional", tahun_masuk:"2010", tahun_keluar:"2012", nilai_akhir:"30", path_ijazah:'A:\START\tutorial' ) }
